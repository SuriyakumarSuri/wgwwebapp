    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          _buildImageSection(
            imagePath:
                'assets/images/images/warehouseservice.jpeg', // Your image path
          ...
          _buildSmallColoredSection(
            ...
            content:
                'Our services are designed to offer seamless, efficient, and cost-effective solutions, ensuring safe storage, real-time tracking, and on-time delivery. Whether it’s cross-docking, inventory management, or freight handling, we ensure a smooth process for your business.',
            backgroundColor: Colors.teal[50],
            titleColor: Colors.teal[900],
            textColor: Colors.teal[700],
          ),
            ...
            child: PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) {
                return [
                  ...
                  buildPopupMenuItem(
                      'DG Cargo Handling', '/logisticstics/cargohandling'),
                  buildPopupMenuItem(
