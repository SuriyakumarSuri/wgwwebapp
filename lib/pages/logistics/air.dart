...
class AirFreightPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(),
      body: ListView(
        children: [
          // About Air Freight Services Section
          _buildColoredSection(
            title: 'About MWT Air Freight Services',
            content:
            'At Modern Western Trans, we provide efficient air freight solutions for a wide range of logistics needs. From time-sensitive shipments to large-scale cargo, we ensure your freight reaches its destination on time and intact.',
          ...
          _buildImageSection(
            imagePath: 'assets/images/images/air.webp',  // Adjust with your own image
            title: 'Our Air Freight Expertise',
            content:
            'With years of experience in air freight management, we specialize in managing urgent shipments, high-value cargo, and large consignments to ensure swift, secure, and timely deliveries.',
          ),

          // Why Choose Us Section in Small Colored Container
          _buildSmallColoredSection(
            title: 'Why Choose MWT?',
            content:
            'We offer customized air freight solutions tailored to your specific needs, backed by a dedicated team, cutting-edge technology, and a network of trusted partners.',
            backgroundColor: Colors.teal[50],
            titleColor: Colors.teal[900],
            textColor: Colors.teal[700],
          ),

          // Our Services Section in Small Colored Container
          _buildSmallColoredSection(
            title: 'Our Air Freight Services Include:',
            content:
            'We handle everything from small packages to large shipments, providing options like express air freight, chartered flights, and consolidated cargo solutions.',
            backgroundColor: Colors.teal[50],
            titleColor: Colors.teal[900],
            textColor: Colors.teal[700],
          ),
  ...
  // Function to Build Small Colored Section (For Why Choose Us and Our Services)
