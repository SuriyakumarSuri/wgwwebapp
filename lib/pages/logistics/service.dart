...
import 'air.dart'; // Import individual service page files
import 'ocean.dart';
import 'land.dart';
import 'warehouse.dart';
import 'custom.dart';
import 'packaging.dart';
import 'cargohandling.dart';
import 'projecthandling.dart';
  ...
  final List<Map<String, String>> services = [
    {
      ...
      'description':
          'Fast and reliable air freight solutions for your business needs.',
    ...
    },
    {
      ...
      'description':
          'Cost-effective ocean freight services to transport your goods.',
    ...
    },
    {
      ...
      'description':
          'Modern warehousing solutions for efficient storage and handling.',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage('assets/images/images/port4.jpg'),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ServiceCard(
                    ...
                    title: service['title']!,
                    route:
                        service['route']!, // Pass the route to the ServiceCard
                  );
                },
              ),
            ),
...
class ServiceCard extends StatelessWidget {
  ...
  ServiceCard({required this.image, required this.title, required this.route});
    ...
    return Card(
      ...
      child: Column(
        children: [
          ...
          // Add the clickable link here, but not the entire card
          Padding(
            padding: EdgeInsets.all(8.0),
            child: InkWell(
              onTap: () {
                // Only navigate when the "Click to view" text is tapped
